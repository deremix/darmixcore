...
#ifndef _REQ_DDB_VERSION
# define _REQ_DDB_VERSION  "DDB_20130614"
#endif //_REQ_DDB_VERSION
...
bool Master::_StartDB()
{
	...
	if (strcmp(db_version, _REQ_DDB_VERSION) != 0)
    {
        sLog.outError(" WARNING:");
        sLog.outError(" Your World DB version: %s is wrong.", db_version);
        sLog.outError(" Required World DB version: %s", _REQ_DDB_VERSION);
        sleep(5);
        return false;
    }
