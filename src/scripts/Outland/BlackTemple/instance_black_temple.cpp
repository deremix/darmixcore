...
struct instance_black_temple : public ScriptedInstance
{
	...
	uint64 IllidanController;
	uint64 IllidanSummoner;
    ...
    Player* GetPlayerInMap()
    {
        ...
        debug_log("DSCR: Instance Black Temple: GetPlayerInMap, but PlayerList is empty!");
        return NULL;
    }
    ...
    void OnCreatureCreate(Creature* pCreature, bool /*add*/)
    {
        ...
        case 50006:    IllidanStormrage = pCreature->GetGUID();          break;
		case 50005:    IllidanController = pCreature->GetGUID();         break;
		case 22997:    IllidanSummoner = pCreature->GetGUID();           break;
    ...
    uint64 GetData64(uint32 identifier)
    {
		...
		case DATA_ILLIDANCONTROLLER:           return IllidanController;
		case DATA_ILLIDANSUMMONER:             return IllidanSummoner;
    ...
    void SetData(uint32 type, uint32 data)
    {
        ...
        case DATA_ILLIDARICOUNCILEVENT:
			...
			if (data == DONE)
			{
				HandleGameObject(IllidanGate, true);
			}
			else
            {
