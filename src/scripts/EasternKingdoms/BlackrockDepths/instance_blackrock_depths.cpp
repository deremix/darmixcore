...
struct instance_blackrock_depths : public ScriptedInstance
{
    ...
    {
        debug_log("DSCR: Instance Blackrock Depths: SetData64 update (Type: %u Data %llu)", type, data);
    ...
    {
        debug_log("DSCR: Instance Blackrock Depths: SetData update (Type: %u Data %u)", type, data);
