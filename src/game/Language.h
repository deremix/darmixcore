...
enum BlizzLikeStrings
{
	...
	LANG_COMMAND_MUTEMESSAGE            = 288,
	LANG_COMMAND_BANACCMESSAGE          = 289,
	LANG_COMMAND_BANCHAMESSAGE          = 290,
	LANG_COMMAND_BANIPMESSAGE           = 291,
	LANG_COMMAND_BANACCPERMAMESSAGE     = 292,
	LANG_COMMAND_BANCHAPERMAMESSAGE     = 293,
	LANG_COMMAND_BANIPPERMAMESSAGE      = 294,
...
//                                      = 710, not used
    ...
    // FREE IDS                           1334-1999
	LANG_SYSTEMMESSAGE_MODERATOR        = 1334,
	LANG_SYSTEMMESSAGE_EVENTER          = 1335,
	LANG_SYSTEMMESSAGE_GAMEMASTER       = 1336,
	LANG_SYSTEMMESSAGE_HEADGM           = 1337,
	LANG_SYSTEMMESSAGE_ADMINISTRATOR    = 1338,
	LANG_SYSTEMMESSAGE_CONSOLE          = 1339,
