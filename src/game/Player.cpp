...
void Player::UpdateArea(uint32 newArea)
{
	...
	if(GetAreaId() == 876 && !isGameMaster())
	{
		GetSession()->SendNotification("Na GM islandu nemas co delat!!");
		TeleportTo(530, -1816.387f, 5334.611328f, -12.428f, 2.035706f); // teleportuje hrace do Shattrathu
	}
...
bool Player::AddItem(uint32 itemId, uint32 count)
{
    ...
    if (noSpaceForCount > 0 || dest.empty())
    {
        ...
        {
            MailDraft draft(GetSession()->GetBlizzLikeString(LANG_ITEM_SAVE_FAILED));
